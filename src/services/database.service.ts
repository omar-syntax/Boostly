...
class DatabaseService {
  ...
  // Transform methods - Enhanced with better error handling
  ...
  private getIconComponent(iconName: string): any {
    // Return icon name as string for now
    // In a real implementation, you would map to actual icon components
